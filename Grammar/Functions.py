...
def welcome(welstr):
    print(f"hello,{welstr}!")


welcome('William')
w = 4
h = 5
print(f'The area is {area(height=h, width=w)}.')
print('----------------------------------------------------------------------')
'''
函数调用
...
'''
以上代码中，[1,2,3] 是 List 类型，"Wiiliam" 是 String 类型，而变量 a 是没有类型
...
#   File "Functions.py", line 173, in <module>
#     printme()
...
# 以下是错误输出
# Traceback (most recent call last):
#   File "Functions.py", line 281, in <module>
#     f(1,2,3)   # 报错
